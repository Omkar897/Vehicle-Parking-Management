...
//        slot.setAvailable(isAvailable);
//        parkingSlotRepository.save(slot);
//        System.out.println("Slot availability updated: " + slotId + " -> " + isAvailable);
//        if (isAvailable) {
...
//                // You can pick the latest booking or just update all paid bookings
//                for (Booking booking : paidBookings) {
//                    booking.setStatus("COMPLETED");
//                    bookingRepository.save(booking);
//                    System.out.println("Booking status updated to COMPLETED for booking id: " + booking.getId());
//                }
//            } else {
//                System.out.println("No PAID bookings found for slot: " + slotId);
//            }
//        }
//    } else {
//        System.out.println("Slot not found for id: " + slotId);
//    }
//}
